...
Run `make gen` to generate game data, native sprite/font sources, and package the FX image with `cgfx-tools`; it requires no Python bridge. `make gen-sprites` explicitly regenerates those sprite/font sources through `cgfx-tools`.
