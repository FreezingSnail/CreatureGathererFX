...
constexpr uint24_t FX_DATA_BYTES = 22177;
...
namespace MenuFXData
{
  ...
  constexpr uint24_t enemyAttackText = 0x00544D;
  constexpr uint24_t damageText = 0x00545A;
}
...
{
    constexpr uint24_t null = 0x005467;
    constexpr uint24_t SquibbleSnail = 0x00546C;
    constexpr uint24_t SquableSnail = 0x005471;
    constexpr uint24_t ScrambleSnail = 0x005476;
    constexpr uint24_t SkitterCrab = 0x00547B;
    constexpr uint24_t ScatterCrab = 0x005480;
    constexpr uint24_t ShatterCrab = 0x005485;
    constexpr uint24_t squid = 0x00548A;
    constexpr uint24_t bigsquid = 0x00548F;
    constexpr uint24_t BiggestSquid = 0x005494;
    constexpr uint24_t bell = 0x005499;
    constexpr uint24_t ember = 0x00549E;
    constexpr uint24_t cuircuit = 0x0054A3;
    constexpr uint24_t hedge = 0x0054A8;
    constexpr uint24_t cloud = 0x0054AD;
    constexpr uint24_t rock = 0x0054B2;
    constexpr uint24_t wiggleworm = 0x0054B7;
    constexpr uint24_t waggleworm = 0x0054BC;
    constexpr uint24_t skimskate = 0x0054C1;
    constexpr uint24_t skimray = 0x0054C6;
    constexpr uint24_t billow = 0x0054CB;
    constexpr uint24_t howl = 0x0054D0;
    constexpr uint24_t item = 0x0054D5;
    constexpr uint24_t item2 = 0x0054DA;
    constexpr uint24_t zip = 0x0054DF;
    constexpr uint24_t zap = 0x0054E4;
    constexpr uint24_t suculent = 0x0054E9;
    constexpr uint24_t cactus = 0x0054EE;
    constexpr uint24_t flickerfly = 0x0054F3;
    constexpr uint24_t flitfly = 0x0054F8;
    constexpr uint24_t dragon = 0x0054FD;
    constexpr uint24_t skull = 0x005502;
    constexpr uint24_t ardu = 0x005507;
}

namespace Names
{
    constexpr uint24_t jimbo = 0x00550C;
}

  constexpr uint24_t teamList = 0x005512;
}
